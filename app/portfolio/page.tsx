...
export const metadata: Metadata = {
  ...
  description: 'See real projects delivered by Mgst in Kenya: Lavan Solar Systems website, BrightSpark Electronics inventory system, NK Medical Missionaries e‑commerce, Powerhub poster design, and more.',
  alternates: {
...
const projects = [
  {
    ...
    tech: ['Next.js 16', 'TypeScript', 'Tailwind CSS', 'Vercel', 'Truehost DNS', 'Dynamic [slug] Routes'],
...
export default function PortfolioPage() {
  ...
  const portfolioJsonLd = {
    ...
    "description": "Real-world software, e-commerce, and branding projects delivered by Maogast Softworks in Nairobi, Kenya.",
    "url": "https://maogastsoftworks.com/portfolio",
  ...
  return (
    <>
      ...
      <Script id="portfolio-collection" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(portfolioJsonLd) }} />
            ...
            {projects.map((project) => (
              <div
                ...
                className={`bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group ${
                  project.badge === 'New' ? 'ring-2 ring-orange-400 ring-offset-2 dark:ring-offset-gray-950' : ''
                }`}
              >
                <div className={`relative h-64 w-full bg-gradient-to-r ${project.color} flex items-center justify-center`}>
                  ...
                  <div className="relative z-10 text-white text-center p-4">
                    <h2 className="text-2xl font-bold drop-shadow-lg">{project.title}</h2>
                    {project.date && (
                      <p className="text-xs text-white/70 mt-2 uppercase tracking-wider">{project.date}</p>
                    )}
                  </div>
                </div>
        ...
        <section className="bg-white dark:bg-gray-900 py-12 border-t border-gray-200 dark:border-gray-800">
          <div className="container mx-auto px-4 text-center max-w-2xl">
            ...
            <p className="text-gray-600 dark:text-gray-400 italic">
              &ldquo;Working with Maogast transformed our online presence. The NK Medical Missionaries platform is fast, secure, and our customers love the easy checkout.&rdquo;
            </p>
