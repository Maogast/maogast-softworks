...
export const metadata: Metadata = {
  ...
  description:
    "Expert software development in Next.js, React, and Node.js. From enterprise systems to mobile apps – we build scalable, secure solutions.",
  openGraph: {
    title: "Software Development Services | Maogast Softworks",
    description:
      "Custom web & mobile apps, cloud integration, IT consulting – tailored to your business.",
    url: "https://maogast-softworks.vercel.app/software",
    siteName: "Maogast Softworks",
    images: [
      {
        url: "https://maogast-softworks.vercel.app/og-software.jpg",
        width: 1200,
        height: 630,
      },
    ],
  ...
  twitter: {
    ...
    description:
      "Build fast, secure web and mobile apps with a modern tech stack.",
...
export default function SoftwarePage() {
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-[#0A192F] to-[#0F2A3F] text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            Custom web & mobile apps, enterprise systems, and IT consulting –
      ...
      {/* Services Grid – with hover scale and icon animations */}
      ...
      {/* Tech Stack – unchanged except added fade-in on scroll (already fine) */}
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={tech}
                  className="px-4 py-2 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-full text-sm font-medium hover:bg-orange-100 dark:hover:bg-orange-900/50 transition-colors cursor-default"
                >
                  {tech}
                </span>
              ))}
      ...
      {/* Our Process – enhanced with icons and better spacing */}
      <section className="py-20 bg-gray-50 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">
      ...
      {/* New micro-section: Case Study teaser (optional, but adds credibility) */}
      <section className="py-16 bg-white dark:bg-gray-900 border-t border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Recent Success</h2>
            <p className="text-gray-600 dark:text-gray-400">A quick look at what we’ve delivered</p>
          </div>
      ...
      <section className="py-20 bg-orange-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-orange-100 max-w-xl mx-auto">
            Let’s talk about your idea. We’ll help you choose the right
            technology and deliver on time.
          </p>
          <div className="mt-8">
            <Link
              href="/quote"
